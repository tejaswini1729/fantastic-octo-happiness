...
const PartVw = ({ selectedPart }) => {
  console.log("Checking selected part",selectedPart)
      ...
      >
        {selectedPart ? (
                  ...
                  imageMetadata.isLoaded && (
                    <>
                        ...
                        <ScaleInvariantMarkupPoint
                          key={selectedPart?.img_pos_id}
                          point={{x:selectedPart?.x, y:selectedPart?.y, position:selectedPart?.position, category:selectedPart?.category}}
                          index={selectedPart?.img_pos_id}
                        />
                    </>
                  )}
          ...
          >
            ...
            >
              {PART_VW?.info ||
                "Select a part to view its image and markup points"}
            </Typography>
          </Box>
        )}
      </Box>
